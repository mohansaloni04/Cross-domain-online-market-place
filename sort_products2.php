        ...
        <div class="row">
          <div class="col-sm-2 sidenav hidden-xs">
            ...
            <ul class="nav nav-pills nav-stacked">
						<li><a href="sort_products2.php?site=marketplace&order=DESC&crit=price">MarketPlace</a></li>
						<li><a href="sort_products2.php?site=thebodykey&order=DESC&crit=price">The Bodykey</a></li>
						<li><a href="sort_products2.php?site=skeonline&order=DESC&crit=price">Skeonline</a></li>
						<li><a href="sort_products2.php?site=thoughtstoaction&order=DESC&crit=price">Thoughts to Action</a></li>
						<li><a href="sort_products2.php?site=chunduridecor&order=DESC&crit=price">Chunduri Decor</a></li>
						<li><a href="sort_products2.php?site=khadikaelectronics&order=DESC&crit=price">Khadi Ka Electronics</a></li>
						<li><a href="sort_products2.php?site=hungerbuddies&order=DESC&crit=price">Hunger Buddies</a></li>
            </ul><br>
          </div>
          <div class="col-sm-10">
